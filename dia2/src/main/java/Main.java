import application.GiftShopSolver;
import infrastructure.FileRangeSource;
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        RangeSource source = new FileRangeSource(inputPath);
        GiftShopSolver solver = new GiftShopSolver(source);
    ...
    private static String defaultInputPath() {
        ...
        return Path.of("dia2", "src", "main", "resources", "input.txt").toString();
    }
}
